...
Materials, data, and analysis code for "Bayesian Reasoning Problems as Calibrated Detectors of LLM Contamination in Online Samples" (Wilde), and for Rarity Roulette, an interactive tool for teaching Bayesian reasoning about low-prevalence screening (e.g., polygraphs, mammography).
...
## Citation
Wilde, V. (2026). Bayesian Reasoning Problems as Calibrated Detectors of LLM Contamination in Online Samples. Manuscript under review, Behavior Research Methods.
