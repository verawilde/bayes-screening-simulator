...
**Paper:** [Accepted manuscript (PDF)](09-03-26_LLM-Canary-accepted-manuscript.pdf) — accepted for publication in *Behavior Research Methods*, September 2026. This is the accepted manuscript, not the Version of Record; it does not reflect post-acceptance copyediting or corrections. The Version of Record will be linked here on publication.
...
Wilde, V. (2026). An LLM Canary in the Online Data Coalmine: Bayesian Reasoning Problems as a Capability-Gap Test for LLM Contamination in Online Samples. *Behavior Research Methods*. Accepted for publication.
